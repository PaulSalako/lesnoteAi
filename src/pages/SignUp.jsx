...
function SignUp() {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      if (file.size > 102400) {
        setErrors(prev => ({
          ...prev,
          profileImage: "File size should not exceed 100KB"
        }));
        e.target.value = '';
        return;
      }
      ...
      if (!file.type.startsWith('image/')) {
        setErrors(prev => ({
          ...prev,
          profileImage: "Invalid file type. Only images are allowed"
        }));
        e.target.value = '';
        return;
      }
  ...
  const validateForm = () => {
    ...
    Object.keys(formData).forEach(field => {
      if (field !== 'profileImage' && field !== 'middleName') {
            ...
            {/* <div className="form-group">
              ...
              <div style={{ 
                ...
                <input
                  ...
                  className={`file-input ${errors.profileImage ? 'error' : ''}`}
                />
                {errors.profileImage && (
  ...
  <label className="checkbox-wrapper mb-4">
    <input 
      type="checkbox"
      id="terms"  // Added id instead of name
